 ...
 * @author Gy Billie
 */
public class SistemaAutoresMDI extends javax.swing.JFrame {

    private InternalFrameAutor Autores;
    /**
     * Creates new form SistemaAutoresMDI
     */
    public SistemaAutoresMDI() {
        initComponents();
        setTitle("Publicaciones");
        Autores = new InternalFrameAutor();
    ...
    private void initComponents() {
        ...
        setExtendedState(SistemaAutoresMDI.MAXIMIZED_BOTH);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SistemaAutoresMDI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SistemaAutoresMDI().setVisible(true);
            }
        });
    }
